...
(function() {
  ...
  Client = (function() {
    ...
    Client.prototype.onReconnect = function() {
      return typeof this.debug === "function" ? this.debug(">>> Reconnecting!") : void 0;
    };

    Client.prototype.onSocketReconnected = function() {
      return typeof this.debug === "function" ? this.debug(">>> Socket Reconnected!") : void 0;
    };

    Client.prototype.onStompReconnected = function(frame) {
      return typeof this.debug === "function" ? this.debug(">>> Stomp Reconnected!") : void 0;
    };

    Client.prototype.onDisconnected = function() {
      return typeof this.debug === "function" ? this.debug(">>> Disconnected!") : void 0;
    };

    Client.prototype.onReady = function(frame) {
      return typeof this.debug === "function" ? this.debug(">>> Ready") : void 0;
    };

    Client.prototype.onConnected = function() {
      return typeof this.debug === "function" ? this.debug(">>> Connected") : void 0;
    };
            ...
            switch (frame.command) {
              case "CONNECTED":
                ...
                if (_this.reconnecting === true) {
                  ...
                  _this.onStompReconnected(frame);
                }
  ...
  Stomp = {
    ...
    over: function(ws, onConnect, onReconnect) {
      var ws_fn;
      ws_fn = typeof ws === "function" ? ws : function() {
        return ws;
      };
    ...
    over: function(ws, onConnect, onReconnect, onDisconnect) {
      var ws_fn;
      ws_fn = typeof ws === "function" ? ws : function() {
        return ws;
      };
