  ...
  Client = (function() {
    ...
    Client.prototype._connect = function() {
      ...
      this.ws.onmessage = (function(_this) {
        return function(evt) {
          var arr, client, data, encodedString, frame, j, len1, messageID, onreceive, ref, subscription, unmarshalledData;
          data = typeof ArrayBuffer !== 'undefined' && evt.data instanceof ArrayBuffer ? (arr = new Uint8Array(evt.data), typeof _this.debug === "function" ? _this.debug("--- got data length: " + arr.length) : void 0, encodedString = String.fromCharCode.apply(null, arr), decodeURIComponent(escape(atob(encodedString)))) : evt.data;
