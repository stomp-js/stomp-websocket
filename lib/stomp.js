...
(function() {
  ...
  Client = (function() {
    ...
    Client.prototype.onSocketConnected = function() {
      return typeof this.debug === "function" ? this.debug(">>> Socket Connected!") : void 0;
    };

    Client.prototype.onStompConnected = function(frame) {
      return typeof this.debug === "function" ? this.debug(">>> Stomp Connected!") : void 0;
    };
    ...
    Client.prototype._connect = function() {
          ...
          for (j = 0, len1 = ref.length; j < len1; j++) {
            ...
            switch (frame.command) {
              case "CONNECTED":
                ...
                results.push(_this.onStompConnected(frame));
                break;
              case "MESSAGE":
      ...
      return this.ws.onopen = (function(_this) {
        return function() {
          ...
          return _this.onSocketConnected();
        };
      })(this);
    };
